...
const buttonVariants = cva(
    'active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-color focus:outline focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disable: opacity-50 disable:pointer-events-none',
    {
        variants: {
           variant: {
